...
background = pygame.Surface((1020,60))
...
def typprüfer():
    ...
    if x[0] == 1:
        ...
        text = font.render(('Spieler_' + str(spielerdran) + ' hat gewonnen'), True, green, blue)
        textRect = text.get_rect()
        textRect.center = (510,460)
        pygame.draw.line(screen, blue, (90 + x[1]*140,850 - x[2]*140), (90 + (x[1] +3)*140,850 - (x[2] -3)*140), 6)
    ...
    for e in range(7):
        for i in range(6):
            ...
            if spielsteinchenliste[nummer] == spielerdran:
                ...
                if counter >= 4:
                    print("Spieler" + str(spielerdran) + " hat gewonnen1")
                    return 1, e, i
                    break
                counter = 0
                #waagrecht
                ...
                if counter >= 4:
                    print("Spieler" + str(spielerdran) + " hat gewonnen2")
                    return 2, e, i
                    break
                counter = 0
                #diagonal hoch
                ...
                if counter >= 4:
                    print("Spieler" + str(spielerdran) + " hat gewonnen3")
                    return 3, e, i
                    break
                counter = 0
                #grade hoch
