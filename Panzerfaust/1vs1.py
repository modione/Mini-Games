...
class Player1:
    ...
    def position(self, nummer):
        ...
        s1=math.sqrt(((((((self.g**2*x**2+30*self.g**2+self.g**2*225)/v**2-2*self.g*(15-self.schussrohry+800))/-2*v)-self.g*x-15*self.g)/v)**2)+v**2-2*self.g*(15-self.schussrohry+800))
        t1 = (-h - math.sqrt(h**2 - 2*self.g*(15 - self.schussrohry + 800))) / self.g
